...
<div class="col-md-8" style="margin:20px auto;width:100%;">
 <div class="container">
 <h3 class="title" >Complaint<span> Booking </span></h3>
<div style="width:28%;margin:0 auto;">
  <a href="complaint_status.php" class="btn btn-theme mr-5" style="background-color:#c0392b;color:#fff;border:none;padding:8px 15px;margin:20px 5px;">Check Current Complaints Status </a>
 </div>
<div class="col-md-6" style="padding:10px 20px;border-right:1px solid #eee;">
  <h2 >What to Complain </h2>
 ...
 <?php if(isset($_SESSION['casUser'])){?>
   <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" accept-charset="utf-8" style="box-shadow:none;" class="sky-form contact-style" onSubmit="return validate_form()" enctype = "multipart/form-data"><div class="form-body">
	...
	<input name="phone" id="phone" class="form-control rounded" placeholder="Enter Your Contact No." type="number" required>
	   ...
	   <div class="form-group"><label for="city" class="control-label"><span style="color:red;">* </span>Complaint Title</label>
	<input name="complaint" id="complaint" class="form-control rounded" placeholder="Enter Your Complaint." type="text" required>
	  </div>
  ...
  <textarea name="desc" id="desc" class="form-control" placeholder="Enter Description" required> </textarea>
    ...
    <label class="control-label">Upload Image  <span class="color-red"></span></label>
     <div style="margin: 10px 0 15px 0;">
    <input type="file" name="test_image" accept="Complaints/*" class="btn btn-file btn-info" ></span>
                                                 </div>
