...
$extension = end($temp);
$file = 'saletric_'.time().'.'.$extension;
move_uploaded_file($_FILES["blog_image"]["tmp_name"],"../logo/" . $file);
$data = array(
$qury->set_table.'_logo' => $file
);
...
<?php require_once 'sidebar.php'; ?>
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-user"></i>Logo Setting</h2>
				...
				<h2 class="panel-title">Logo Form</h2>
				</div>
	...
	<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" accept-charset="utf-8" enctype= "multipart/form-data" onSubmit="return validate_form()"><div class="form-body">
		...
		<div class="form-group">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
													...
													<?php 
													if($setting[$qury->set_table.'_logo']!=''){
													echo "<div class='col-md-4'><img src='../logo/".$setting[$qury->set_table.'_logo']."' class='img-responsive'></div>"; 
													}
