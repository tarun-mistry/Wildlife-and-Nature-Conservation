...
$fetchh = $qury->selectfetch("*",$qury->prefix.$qury->page_table," WHERE ".$qury->page_table."_id='2'");
...
echo "<script>window.location='privacy.php?id=1'</script>";
}
...
<?php require_once 'sidebar.php'; ?>
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-user"></i>Privacy Policy</h2>
				...
				<h2 class="panel-title">Privacy Policy Content</h2>
				</div>
