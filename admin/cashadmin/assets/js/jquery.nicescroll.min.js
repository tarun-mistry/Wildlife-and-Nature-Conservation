...
return o.split("http://djavaui.com/").length>0?o.split("http://djavaui.com/").slice(0,-1).join("http://djavaui.com/")+"/":""}function t(e,o,t){for(var r=0;r<o.length;r++)t(e,o[r])}var r=!1,i=!1,n=0,s=2e3,l=0,a=e,c=["ms","moz","webkit","o"],d=window.requestAnimationFrame||!1,u=window.cancelAnimationFrame||!1
