...
<?php require_once 'sidebar.php'; ?>
            ...
            <section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-user"></i>Pending Transaction </h2>
					...
					<div class="row">
						...
						<div class="table-responsive mb-20">
                                <table class="table table-striped table-theme table-responsive">
									...
									$page = $qury->pagination("*",$qury->cash_table,20,$_SERVER['PHP_SELF']," WHERE ".$qury->cash_table."_status='1'","");
									
									$trans_select = $qury->selectr("*",$qury->prefix.$qury->cash_table," WHERE ".$qury->cash_table."_status='1' ORDER BY ".$qury->cash_table."_id DESC $page[0]");
