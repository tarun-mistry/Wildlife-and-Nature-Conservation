var BlankonForm = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonForm.chosenSelect();
            BlankonForm.bootstrapSwitch();
            BlankonForm.inputMask();
            BlankonForm.bootstrapDatepicker();
            BlankonForm.bootstrapWYSIHTML5();
            BlankonForm.summernote();
            BlankonForm.editable();
            BlankonForm.jqueryValidation();
            BlankonForm.twitterBootstrapWizard();
            BlankonForm.textareaMaxlength();
            BlankonForm.textareaAutosize();
        },
